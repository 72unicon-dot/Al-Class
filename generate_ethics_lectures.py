...
target_pdf_eu = "https://firebasestorage.googleapis.com/v0/b/lms01-bc677.firebasestorage.app/o/resources%2F1770158110908_cleaned_AI_Global_Law_Survival.pdf?alt=media&token=6dcf8a5e-83ff-4eaf-9b6b-4a3dfce2143a"
class1_content += get_card("globe", "blue", "글로벌 AI 규제: EU AI Act", "세계 최초의 포괄적 AI 규제법인 EU AI Act의 등급별 규제와 기업 영향을 알아봅니다.", ["EU AI Act", "Risk-based"], "textbook_ethics_eu_act.html", target_pdf_eu)
